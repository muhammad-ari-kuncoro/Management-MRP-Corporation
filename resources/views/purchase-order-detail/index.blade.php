                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="po_date"
                                value="{{ $purchaseOrder->po_date ?? date('Y-m-d') }}" required readonly disabled>
                        </div>
                        <div class="col-6 mb-3">
        ...
        <table class="table table-bordered align-middle">
            ...
            <tbody id="itemTableBody">
                ...
                <tr data-id="{{ $data->id }}">
                    ...
                    <td>Rp {{ number_format($data->items->price_item ?? 0, 3, ',', '.') }}</td>
                    <td>
        ...
        <div class="col-md-5">
            <table class="table">
                ...
                <tr>
                    <td>PPN (11%)</td>
                    <td class="text-end">
                        <input type="number" id="ppn-input" class="form-control form-control-sm text-end" value="11"
                            readonly>
                    </td>
                </tr>
                <tr>
        ...
        function updateGrandTotal() {
            ...
            document.querySelectorAll('#itemTableBody tr[data-id]').forEach(row => {
                const priceText = (row.querySelector('td:nth-child(6)') ? .textContent || '').replace(
                    /[^\d,-]/g, '');
                const discountText = (row.querySelector('td:nth-child(7)') ? .textContent || '')
                    .replace('%', '');
            ...
            const ppnValueInput = document.getElementById('ppn-value');
            ...
            if (ppnValueInput)
                ppnValueInput.value = "Rp " + ppn.toLocaleString('id-ID', {
                    minimumFractionDigits: 2
                });
