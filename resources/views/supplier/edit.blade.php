        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('supplier-company.update',$dataSupplierById->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            {{-- Kolom Kiri --}}
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $dataSupplierById->name_suppliers }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $dataSupplierById->nickname_suppliers }}"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ $dataSupplierById->phone_number }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="type_suppliers" id="type_suppliers" class="form-select" required>
                                            <option value="" disabled>-- Pilih Type Supplier --</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ $dataSupplierById->email }}" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="brand" class="form-control @error('brand') is-invalid @enderror"
                                        id="brand" name="brand" value="{{ $dataSupplierById->brand }}" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" id="address"
                                        name="address" rows="3"
                                        placeholder="Harap Di isi Alamat Supplier">{{ $dataSupplierById->address }}</textarea>
                                    @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address_shipping') is-invalid @enderror"
                                        ...
                                        required>{{{ $dataSupplierById->address_shipping }}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_pic') is-invalid @enderror"
                                        id="name_pic" name="name_pic" value="{{ $dataSupplierById->name_pic }}"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        required value="{{ $dataSupplierById->phone_number_pic }}"
                                        onkeydown="return event.keyCode !== 69 && event.keyCode !== 189 && event.keyCode !== 187"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('npwp') is-invalid @enderror"
                                        id="npwp" name="npwp" value="{{$dataSupplierById->npwp}}" min="0"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('scan_npwp') is-invalid @enderror"
                                        id="scan_npwp" name="scan_npwp" value="{{ $dataSupplierById->scan_npwp }}"
                                    ...
                                    <div class="mb-3 mt-3">
                                        <p class="mb-3 mt-3 text-muted">Scan NPWP Lama:</p>
                                        <img src="{{ asset('storage/' . $dataSupplierById->scan_npwp) }}"
                                        alt="Scan NPWP Lama"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('website') is-invalid @enderror"
                                        ...
                                        value="{{$dataSupplierById->website}}" required>
                                    @error('website')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_rek') is-invalid @enderror"
                                        id="no_rek" name="no_rek" value="{{ $dataSupplierById->no_rek }}"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('top') is-invalid @enderror"
                                        ...
                                        onkeydown="return event.keyCode !== 69 && event.keyCode !== 189 && event.keyCode !== 187"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="{{ $dataSupplierById->top}}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        required value="{{ $dataSupplierById->limit_kredit }}"
                                        onkeydown="return event.keyCode !== 69 && event.keyCode !== 189 && event.keyCode !== 187"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                    @error('limit_kredit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('sales') is-invalid @enderror"
                                        id="sales" name="sales" value="{{ $dataSupplierById->sales }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="method_payment" name="method_payment" value="{{ $dataSupplierById->method_payment }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="method_shipping" name="method_shipping" value="{{ $dataSupplierById->method_shipping }}"
                                        placeholder="Harap Di Isi" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $dataSupplierById->duration_shipping }}" min="0"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('id_region') is-invalid @enderror"
                                        id="id_region" name="id_region" value="{{ $dataSupplierById->id_region }}" min="0"
                                        required>
                                    @error('id_region')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="branch_company_id" id="branch_company_id" class="form-select" required>
                                            <option value="" disabled>-- Pilih Cabang --</option>
                                            @foreach ($branchCompany as $data)
                                                <option value="{{ $data->id }}"
                                                    {{ $dataSupplierById->branch_company_id == $data->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('bank') is-invalid @enderror"
                                        id="bank" name="bank" required value="{{ $dataSupplierById->bank }}">
                                    @error('bank')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('siup') is-invalid @enderror"
                                        id="siup" name="siup" value="{{ $dataSupplierById->siup }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('scan_siup') is-invalid @enderror"
                                        id="scan_siup" name="scan_siup" onchange="previewSIUP(event)" value="{{ $dataSupplierById->scan_siup }}">
                                    @error('scan_siup')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="mb-3 mt-3">
                                        <p class="mb-3 mt-3 text-muted">Scan SIUP Lama:</p>
                                        <img src="{{ asset('storage/' . $dataSupplierById->scan_siup) }}"
                                        alt="Scan NPWP Lama"
                                        class="rounded border"
                                        style="max-height: 120px;">
                                    </div>
