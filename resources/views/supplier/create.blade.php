        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="name_suppliers" class="form-label">Nama Supplier <span class="text-danger">*</span></label>
                            <input type="text"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="type_suppliers" class="form-label">Tipe Supplier <span class="text-danger">*</span></label>
                            <select name="type_suppliers" id="type_suppliers" class="form-select @error('type_suppliers') is-invalid @enderror" required>
                                <option value="" disabled selected>-- Pilih Tipe Supplier --</option>
                                <option value="Manufaktur" {{ old('type_suppliers') == 'Manufaktur' ? 'selected' : '' }}>Manufaktur</option>
                                <option value="Kuliner" {{ old('type_suppliers') == 'Kuliner' ? 'selected' : '' }}>Kuliner</option>
                                <option value="Garment" {{ old('type_suppliers') == 'Garment' ? 'selected' : '' }}>Garment</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="branch_company_id" class="form-label">Cabang <span class="text-danger">*</span></label>
                            <select name="branch_company_id" id="branch_company_id" class="form-select @error('branch_company_id') is-invalid @enderror" required>
                                <option value="" disabled selected>-- Pilih Cabang --</option>
                                @foreach ($branchCompany as $data)
                                    <option value="{{ $data->id }}" {{ old('branch_company_id') == $data->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="phone_number" class="form-label">No. Telepon Supplier <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="address_shipping" class="form-label">Alamat Pengiriman <span class="text-danger">*</span></label>
                            <textarea class="form-control @error('address_shipping') is-invalid @enderror"
                                id="address_shipping" name="address_shipping" rows="3"
                                placeholder="Masukkan alamat pengiriman" required>{{ old('address_shipping') }}</textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="name_pic" class="form-label">Nama PIC <span class="text-danger">*</span></label>
                            <input type="text"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="phone_number_pic" class="form-label">No. Telepon PIC <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">+62</span>
                                <input type="number"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="method_payment" class="form-label">Metode Pembayaran <span class="text-danger">*</span></label>
                            <input type="text"
                                class="form-control @error('method_payment') is-invalid @enderror"
                                id="method_payment" name="method_payment"
                                value="{{ old('method_payment') }}"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="top" class="form-label">Jatuh Tempo <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="number"
                                    class="form-control @error('top') is-invalid @enderror"
                                    id="top" name="top"
                                    value="{{ old('top') }}"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="limit_kredit" class="form-label">Limit Kredit <span class="text-danger">*</span></label>
                            <input type="number"
                                class="form-control @error('limit_kredit') is-invalid @enderror"
                                id="limit_kredit" name="limit_kredit"
                                value="{{ old('limit_kredit') ?? 0 }}" required>
                            @error('limit_kredit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="method_shipping" class="form-label">Metode Pengiriman <span class="text-danger">*</span></label>
                            <input type="text"
                                class="form-control @error('method_shipping') is-invalid @enderror"
                                id="method_shipping" name="method_shipping"
                                value="{{ old('method_shipping') }}"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="duration_shipping" class="form-label">Durasi Pengiriman <span class="text-danger">*</span></label>
                            <input type="text"
                                class="form-control @error('duration_shipping') is-invalid @enderror"
                                id="duration_shipping" name="duration_shipping"
                                value="{{ old('duration_shipping') }}"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="id_region" class="form-label">ID Region <span class="text-danger">*</span></label>
                            <input type="number"
                                class="form-control @error('id_region') is-invalid @enderror"
                                id="id_region" name="id_region"
                                value="{{ old('id_region') ?? 0 }}" min="0" required>
                            @error('id_region')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="sales" class="form-label">Nama Sales <span class="text-danger">*</span></label>
                            <input type="text"
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="scan_npwp" class="form-label">Upload Dokumen Scan NPWP</label>
                            <input type="file"
                                class="form-control @error('scan_npwp') is-invalid @enderror"
                                id="scan_npwp" name="scan_npwp"
                                onchange="previewFile(event, 'npwp')">
                            @error('scan_npwp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="mt-3" id="preview-container-npwp" style="display:none;">
                                <p class="mb-1 fw-bold text-muted" style="font-size:13px;">Preview NPWP:</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="scan_siup" class="form-label">Upload Dokumen Scan SIUP</label>
                            <input type="file"
                                class="form-control @error('scan_siup') is-invalid @enderror"
                                id="scan_siup" name="scan_siup"
                                onchange="previewFile(event, 'siup')">
                            @error('scan_siup')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="mt-3" id="preview-container-siup" style="display:none;">
                                <p class="mb-1 fw-bold text-muted" style="font-size:13px;">Preview SIUP:</p>
...
@push('scripts')
<script>
    // Satu fungsi reusable untuk semua input number — blokir e, -, +
    ...
    // Satu fungsi reusable untuk preview NPWP & SIUP
